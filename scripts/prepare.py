...
"""Generates everything that is not kept as source in the project. Only does what is missing.
  ...
  - the Figtree and Faustina fonts in app/www/fonts/ (downloaded from Google Fonts, verified by SHA-256)
...
# Figtree for everything, Faustina for headings and numbers (design rules in PROJECT.md)
FONTS = {
    'figtree-latin.woff2': (
