...
const I = {
  r_top: BOWL + HEART,
  r_gut: BOWL + LATER,
  r_mittel: '<path d="M5.3 14.3h13.4l-.75 3.1a1.4 1.4 0 0 1-1.36 1.07H7.41A1.4 1.4 0 0 1 6.05 17.4z" fill="currentColor" fill-opacity=".35" stroke="none"/>' + BOWL,
  r_sosse: BOWL + DOT(9, 15.4) + DOT(12.2, 16.2) + DOT(15.1, 15.2) + '<path d="M12 2.8c1.2 1.5 2.1 2.7 2.1 3.8a2.1 2.1 0 0 1-4.2 0c0-1.1.9-2.3 2.1-3.8z"/>',
  r_schlecht: FULL,
  r_gern: BOWL + HEART,
  r_normal: BOWL,
  ...
  r_angeknabbert: '<path d="M11.55 8.73A6 6 0 1 0 15.27 12.45 2.7 2.7 0 0 1 11.55 8.73z"/>' + CRUMBS + DOT(17.8, 8.2) + DOT(19.6, 11.4),
  r_unberuehrt: TREAT + '<path d="M16.3 5.8h4.6"/>',
  bowl: '<path class="fill" fill="currentColor" stroke="none" d="M3.5 11h17l-1.5 6.3a2.3 2.3 0 0 1-2.24 1.77H7.24A2.3 2.3 0 0 1 5 17.3z"/>' + BOWL + '<path d="M12 5.2v3.6M10.2 7h3.6"/>',
  barcode: '<path d="M4 8.5V6.3A2.3 2.3 0 0 1 6.3 4h2.2M15.5 4h2.2A2.3 2.3 0 0 1 20 6.3v2.2M20 15.5v2.2a2.3 2.3 0 0 1-2.3 2.3h-2.2M8.5 20H6.3A2.3 2.3 0 0 1 4 17.7v-2.2"/><path d="M8 8.5v7M10.6 8.5v7M13.4 8.5v7M16 8.5v7"/>',
  camera: '<path d="M3.5 8.8a2.3 2.3 0 0 1 2.3-2.3h1.7l1.3-1.9a1.4 1.4 0 0 1 1.16-.6h4.08a1.4 1.4 0 0 1 1.16.6l1.3 1.9h1.7a2.3 2.3 0 0 1 2.3 2.3v8.4a2.3 2.3 0 0 1-2.3 2.3H5.8a2.3 2.3 0 0 1-2.3-2.3z"/><circle cx="12" cy="12.9" r="3.4"/>',
  ...
  trash: '<path d="M4.5 7h15M9.5 7V5.2c0-.7.5-1.2 1.2-1.2h2.6c.7 0 1.2.5 1.2 1.2V7M6.5 7l.8 11.3a2 2 0 0 0 2 1.7h5.4a2 2 0 0 0 2-1.7L17.5 7M10.2 11v5M13.8 11v5"/>',
  ...
  trophy: '<path d="M8 4.5h8v4.2a4 4 0 0 1-8 0z"/><path d="M8 6H5.6v1a2.6 2.6 0 0 0 2.6 2.6M16 6h2.4v1a2.6 2.6 0 0 1-2.6 2.6M12 12.7v3.6M8.8 19.5h6.4M9.9 16.3h4.2l.6 3.2H9.3z"/>',
  clock: '<circle cx="12" cy="12" r="8"/><path d="M12 8v4.3l2.8 1.7"/>',
  crop: '<path d="M7 3.5v13.5h13.5M3.5 7H17v13.5"/>',
  ...
  alert: '<path d="M10.6 5.2a1.6 1.6 0 0 1 2.8 0l6.6 11.9a1.6 1.6 0 0 1-1.4 2.4H5.4A1.6 1.6 0 0 1 4 17.1z"/><path d="M12 9.8v3.7M12 16.4v.2"/>',
  refresh: '<path d="M19 12.5a7 7 0 0 1-12.4 4.1M5 11.5a7 7 0 0 1 12.4-4.1"/><path d="M17.8 3.9v3.8H14M6.2 20.1v-3.8H10"/>',
  ...
  rabbit: '<path d="M9.9 9.3C8.6 7.4 8 4.9 8.6 3.8c.8-1.3 2.6.6 3.2 4.6M14.1 9.3c1.3-1.9 1.9-4.4 1.3-5.5-.8-1.3-2.6.6-3.2 4.6"/><circle cx="12" cy="14.3" r="5.6"/><path d="M10 13.6v.4M14 13.6v.4M11.2 16.3h1.6"/>',
...
const S = {
  ...
  camera: BUBBLE + '<path d="M25 26.5a2 2 0 0 1 2-2h2.4l1.4-2h5.4l1.4 2H40a2 2 0 0 1 2 2v9.5a2 2 0 0 1-2 2H27a2 2 0 0 1-2-2z"/><circle cx="33.5" cy="31.2" r="3.3"/>'
};
export const sketch = (n, cls = '') => `<svg class="sk ${cls}" viewBox="0 0 64 64" aria-hidden="true">${S[n] || ''}</svg>`;

export const icon = (n, cls = '') => `<svg class="ic ${cls}" viewBox="0 0 24 24" aria-hidden="true">${I[n] || ''}</svg>`;
